...
class AddressBook(UserDict):
    ...
    def is_email_unique(self, email: str) -> bool:
        """Перевіряє, чи унікальний email в адресній книзі.
        
        Args:
            email: str: email для перевірки
            
        Returns:
            bool: True, якщо email унікальний, False в іншому випадку"""
    ...
    def is_phone_unique(self, phone: str) -> bool:
        """Перевіряє, чи унікальний номер телефону в адресній книзі.
        
        Args:
            phone: str: номер телефону для перевірки
            
        Returns:
            bool: True, якщо номер телефону унікальний, False в іншому випадку"""
        for record in self.data.values():
